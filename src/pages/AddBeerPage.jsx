        ...
        <div className="container mt-4">
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="tagline" name="tagline" value={form.tagline} onChange={handleChange} />
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="first_brewed" name="first_brewed" value={form.first_brewed} onChange={handleChange} />
                </div>
                <div className="mb-3">
                    <label htmlFor="brewers_tips" className="form-label">Brewer Tips</label>
                    <input type="text" className="form-control" id="brewers_tips" name="brewers_tips" value={form.brewers_tips} onChange={handleChange} />
                </div>
                <div className="mb-3">
                    <label htmlFor="attenuation_level" className="form-label">Attenuation Level</label>
                    <input type="number" className="form-control" id="attenuation_level" name="attenuation_level" value={form.attenuation_level} onChange={handleChange} />
                </div>
                <div className="mb-3">
                    <label htmlFor="contributed_by" className="form-label">Contributed By</label>
                    <input type="text" className="form-control" id="contributed_by" name="contributed_by" value={form.contributed_by} onChange={handleChange} />
                </div>
